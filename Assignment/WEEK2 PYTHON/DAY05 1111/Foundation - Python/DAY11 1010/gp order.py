# Initialize customer details, product catalog, and order history dictionaries
customers = {}
product_catalog = {
...
# Function to accept and store customer details
def add_customer(customer_id):
    name = input("Enter customer name: ")
    address = input("Enter customer address: ")
    phone = input("Enter customer phone number: ")
    customers[customer_id] = {"name": name, "address": address, "phone": phone}
